...
// 		if (searchTerm.trim()) {
// 			try {
// 				const response = await api.get(`/product/search?query=${searchTerm}`);
...
// 								{items > 0 && (
// 									<span className="absolute top-0 right-0 -mt-2 -mr-2 h-5 w-5 rounded-full bg-red-500 text-white text-xs flex items-center justify-center">
// 										{items}
// 									</span>
// 								)}
// 							</Link>
